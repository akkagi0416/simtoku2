...
?>
  <ul class="sns_button">
   <li><span class="sns_button__bal"><?php if(function_exists('get_scc_twitter')) echo get_scc_twitter(); ?></span><a href="https://twitter.com/intent/tweet?url=<?php the_permalink(); ?>&text=<?php echo get_the_title(); ?>&via=【自分のユーザー名】" target="_blank"><span class="sns_button__icon sns_button__icon_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></span></a></li>
