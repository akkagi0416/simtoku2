...
?>
  <ul class="sns_button">
   <li><span class="sns_button__bal"><?php if(function_exists('get_scc_twitter')) echo get_scc_twitter( array( post_id => 'home' ) ); ?></span><a href="https://twitter.com/intent/tweet?url=<?php the_permalink(); ?>&text=<?php echo get_the_title(); ?>&via=akkagi0416" target="_blank"><span class="sns_button__icon sns_button__icon_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></span></a></li>
   <li><span class="sns_button__bal"><?php if(function_exists('get_scc_facebook')) echo get_scc_facebook( array( post_id => 'home' ) ) ; ?></span><a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank"><span class="sns_button__icon sns_button__icon_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></span></a></li>
   <li><span class="sns_button__bal"><?php if(function_exists('get_scc_hatebu')) echo get_scc_hatebu( array( post_id => 'home' ) ); ?></span><a href="http://b.hatena.ne.jp/add?mode=confirm&url=<?php the_permalink(); ?>&title=<?php echo get_the_title(); ?>" target="_blank"><span class="sns_button__icon sns_button__icon_hatebu">B!</span></a></li>
   <li><span class="sns_button__bal"><?php if(function_exists('get_scc_gplus')) echo get_scc_gplus( array( post_id => 'home' ) ); ?></span><a href="https://plus.google.com/share?url=<?php the_permalink(); ?>" target="_blank"><span class="sns_button__icon sns_button__icon_googleplus"><i class="fa fa-google-plus" aria-hidden="true"></i></span></a></li>
